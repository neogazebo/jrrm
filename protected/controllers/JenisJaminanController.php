...
class JenisJaminanController extends Controller
{
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['JenisJaminan']))
			$model->attributes=$_GET['JenisJaminan'];
	...
	{
		$model=JenisJaminan::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='jenis-jaminan-form')
		{
